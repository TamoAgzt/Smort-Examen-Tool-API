...
CREATE TABLE IF NOT EXISTS `Examen` (`Id` integer PRIMARY KEY AUTO_INCREMENT, `Naam_Examen` varchar(64),`Vak_Examen` varchar(64), Toezichthouders_Id integer, FOREIGN KEY (`Toezichthouders_Id`) REFERENCES `Gebruikers` (`Id`));
